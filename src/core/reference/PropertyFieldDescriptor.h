...
protected:
	...
	const OvitoObjectType* _targetClassDescriptor = nullptr;
	...
	QVariant (*propertyStorageReadFunc)(RefMaker*) = nullptr;
	...
	void (*propertyStorageSaveFunc)(RefMaker*, SaveStream&) = nullptr;
