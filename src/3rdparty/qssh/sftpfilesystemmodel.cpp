...
QVariant SftpFileSystemModel::data(const QModelIndex &index, int role) const
{
    ...
    if (index.column() == 0 && role == Qt::DecorationRole) {
        ...
        case FileTypeOther:
            return QIcon(QLatin1String(":/gui/images/unknownfile.png"));
        case FileTypeDirectory:
            return QIcon(QLatin1String(":/gui/images/dir.png"));
        case FileTypeUnknown:
            return QIcon(QLatin1String(":/gui/images/help.png")); // Shows a question mark.
        }
    }
    if (index.column() == 1) {
