...
public:
    ...
    void visit(Class& cl) const {
        cl
			...
			.def(init<value_type>())
			.def("__init__", make_constructor(+[]() { return new Vector_3<value_type>(typename Vector_3<value_type>::Zero()); }))
			.add_property("x", static_cast<value_type (Vector_3<value_type>::*)() const>(&Vector_3<value_type>::x), +[](Vector_3<value_type>& v, value_type x) { v.x() = x; })
			.add_property("y", static_cast<value_type (Vector_3<value_type>::*)() const>(&Vector_3<value_type>::y), +[](Vector_3<value_type>& v, value_type y) { v.y() = y; })
			.add_property("z", static_cast<value_type (Vector_3<value_type>::*)() const>(&Vector_3<value_type>::z), +[](Vector_3<value_type>& v, value_type z) { v.z() = z; })
...
BOOST_PYTHON_MODULE(PyScriptLinearAlgebra)
{
	...
	class_<Vector2>("Vector2", init<FloatType, FloatType>())
		.def(init<FloatType>())
        .def("__init__", make_constructor(+[]() { return new Vector2(Vector2::Zero()); }))
        .add_property("x", static_cast<FloatType (Vector2::*)() const>(&Vector2::x), +[](Vector2& v, FloatType x) { v.x() = x; })
        .add_property("y", static_cast<FloatType (Vector2::*)() const>(&Vector2::y), +[](Vector2& v, FloatType y) { v.y() = y; })
	...
	class_<Vector4>("Vector4", init<FloatType, FloatType, FloatType, FloatType>())
		.def(init<FloatType>())
        .def("__init__", make_constructor(+[]() { return new Vector4(Vector4::Zero()); }))
        .add_property("x", static_cast<FloatType (Vector4::*)() const>(&Vector4::x), +[](Vector4& v, FloatType x) { v.x() = x; })
        .add_property("y", static_cast<FloatType (Vector4::*)() const>(&Vector4::y), +[](Vector4& v, FloatType y) { v.y() = y; })
        .add_property("z", static_cast<FloatType (Vector4::*)() const>(&Vector4::z), +[](Vector4& v, FloatType z) { v.z() = z; })
        .add_property("w", static_cast<FloatType (Vector4::*)() const>(&Vector4::w), +[](Vector4& v, FloatType w) { v.w() = w; })
	...
	class_<Point3>("Point3", init<FloatType, FloatType, FloatType>())
		.def(init<FloatType>())
        .def("__init__", make_constructor(+[]() { return new Point3(Point3::Origin()); }))
        .add_property("x", static_cast<FloatType (Point3::*)() const>(&Point3::x), +[](Point3& p, FloatType x) { p.x() = x; })
        .add_property("y", static_cast<FloatType (Point3::*)() const>(&Point3::y), +[](Point3& p, FloatType y) { p.y() = y; })
        .add_property("z", static_cast<FloatType (Point3::*)() const>(&Point3::z), +[](Point3& p, FloatType z) { p.z() = z; })
	...
	class_<Point2>("Point2", init<FloatType, FloatType>())
		.def(init<FloatType>())
        .def("__init__", make_constructor(+[]() { return new Point2(Point2::Origin()); }))
        .add_property("x", static_cast<FloatType (Point2::*)() const>(&Point2::x), +[](Point2& p, FloatType x) { p.x() = x; })
        .add_property("y", static_cast<FloatType (Point2::*)() const>(&Point2::y), +[](Point2& p, FloatType y) { p.y() = y; })
		.def(self + other<Vector2>())
	...
	class_<Quaternion>("Quaternion", init<FloatType, FloatType, FloatType, FloatType>())
        ...
        .def("__init__", make_constructor(+[]() { return new Quaternion(Quaternion::Identity()); }))
        .add_property("x", static_cast<FloatType (Quaternion::*)() const>(&Quaternion::x), +[](Quaternion& q, FloatType x) { q.x() = x; })
        .add_property("y", static_cast<FloatType (Quaternion::*)() const>(&Quaternion::y), +[](Quaternion& q, FloatType y) { q.y() = y; })
        .add_property("z", static_cast<FloatType (Quaternion::*)() const>(&Quaternion::z), +[](Quaternion& q, FloatType z) { q.z() = z; })
        .add_property("w", static_cast<FloatType (Quaternion::*)() const>(&Quaternion::w), +[](Quaternion& q, FloatType w) { q.w() = w; })
	...
	class_<Rotation>("Rotation", init<const Vector3&, FloatType, optional<bool>>())
        ...
        .def("__init__", make_constructor(+[]() { return new Rotation(Rotation::Identity()); }))
	...
	class_<Scaling>("Scaling", init<const Vector3&, const Quaternion&>())
        .def("__init__", make_constructor(+[]() { return new Scaling(Scaling::Identity()); }))
	...
	class_<Color>("Color", init<FloatType, FloatType, FloatType>())
		.def(init<FloatType>())
        .def("__init__", make_constructor(+[]() { return new Color(0,0,0); }))
        .add_property("r", static_cast<FloatType (Color::*)() const>(&Color::r), +[](Color& c, FloatType r) { c.r() = r; })
        .add_property("g", static_cast<FloatType (Color::*)() const>(&Color::g), +[](Color& c, FloatType g) { c.g() = g; })
        .add_property("b", static_cast<FloatType (Color::*)() const>(&Color::b), +[](Color& c, FloatType b) { c.b() = b; })
	...
	class_<ColorA>("ColorA", init<FloatType, FloatType, FloatType, optional<FloatType>>())
        .def("__init__", make_constructor(+[]() { return new ColorA(0,0,0); }))
        .add_property("r", static_cast<FloatType (ColorA::*)() const>(&ColorA::r), +[](ColorA& c, FloatType r) { c.r() = r; })
        .add_property("g", static_cast<FloatType (ColorA::*)() const>(&ColorA::g), +[](ColorA& c, FloatType g) { c.g() = g; })
        .add_property("b", static_cast<FloatType (ColorA::*)() const>(&ColorA::b), +[](ColorA& c, FloatType b) { c.b() = b; })
        .add_property("a", static_cast<FloatType (ColorA::*)() const>(&ColorA::a), +[](ColorA& c, FloatType a) { c.a() = a; })
	...
	class_<Matrix3>("Matrix3", init<FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType>())
        ...
        .def("__init__", make_constructor(+[]() { return new Matrix3(Matrix3::Identity()); }))
        ...
        .def("get", +[](const Matrix3& m, int row, int col) { return m(row,col); })
        .def("set", +[](Matrix3& m, int row, int col, FloatType v) { m(row,col) = v; })
	...
	class_<AffineTransformation>("AffineTransformation", init<FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType>())
        ...
        .def("__init__", make_constructor(+[]() { return new AffineTransformation(AffineTransformation::Identity()); }))
        ...
        .def("get", +[](const AffineTransformation& m, int row, int col) { return m(row,col); })
        .def("set", +[](AffineTransformation& m, int row, int col, FloatType v) { m(row,col) = v; })
		.def(self * other<AffineTransformation>())
		.def(self * other<Matrix3>())
		.def(self * other<Point3>())
		.def(self * other<Vector3>())
	...
	class_<Matrix4>("Matrix4", init<FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType,FloatType>())
		.def(init<const AffineTransformation&>())
        .def("__init__", make_constructor(+[]() { return new Matrix4(Matrix4::Identity()); }))
        ...
        .def("get", +[](const Matrix4& m, int row, int col) { return m(row,col); })
        .def("set", +[](Matrix4& m, int row, int col, FloatType v) { m(row,col) = v; })
		.def(self * other<AffineTransformation>())
