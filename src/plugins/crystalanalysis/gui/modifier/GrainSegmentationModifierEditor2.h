...
#ifndef __OVITO_GRAIN_SEGMENTATION_MODIFIER_EDITOR2_H
#define __OVITO_GRAIN_SEGMENTATION_MODIFIER_EDITOR2_H
 ...
 */
class GrainSegmentationModifierEditor2 : public ParticleModifierEditor
{
public:

	/// Default constructor.
	Q_INVOKABLE GrainSegmentationModifierEditor2() {}
