...
#ifndef __OVITO_GRAIN_SEGMENTATION_ENGINE2_H
#define __OVITO_GRAIN_SEGMENTATION_ENGINE2_H
 ...
 */
class GrainSegmentationEngine2 : public StructureIdentificationModifier::StructureIdentificationEngine
{
public:
