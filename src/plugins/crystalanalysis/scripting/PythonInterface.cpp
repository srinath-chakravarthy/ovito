...
//#if 0
	  ...
	  ":Base Class::py:class:`ovito.modifiers.Modifier`\n\n"
	  "This modifier computes atomic clusters based on structureIdentification based on :py:class:`~ovito.modifier.PolyhedralTemplateMatchingModifier\n`"
		...
		.def_property("output_mesh", &GrainSegmentationModifier::outputPartitionMesh, &GrainSegmentationModifier::setOutputPartitionMesh,
				...
				"If true, the modifier will generate a geometric representation of the grain boundary network "
                                ...
                                "\n\n"
                                ":Default: ``False``\n")
                .def_property("output_orientations", &GrainSegmentationModifier::outputLocalOrientations, &GrainSegmentationModifier::setOutputLocalOrientations,
...
//#endif
        ...
        ovito_class<ClusterGraphObject, DataObject>(m, "ClusterGraph")
                .def_property_readonly("clusters", &ClusterGraphObject::clusters, py::return_value_policy::reference_internal)
                .def("find_cluster", &ClusterGraphObject::findCluster, py::return_value_policy::reference_internal)
        ;
