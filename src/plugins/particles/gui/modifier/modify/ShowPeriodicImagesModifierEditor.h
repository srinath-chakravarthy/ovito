...
#ifndef __OVITO_SHOW_PERIODIC_IMAGES_MODIFIER_EDITOR_H
#define __OVITO_SHOW_PERIODIC_IMAGES_MODIFIER_EDITOR_H
...
#endif // __OVITO_SHOW_PERIODIC_IMAGES_MODIFIER_EDITOR_H
