...
#ifndef __OVITO_LOAD_TRAJECTORY_MODIFIER_EDITOR_H
#define __OVITO_LOAD_TRAJECTORY_MODIFIER_EDITOR_H
 ...
 */
class LoadTrajectoryModifierEditor : public ParticleModifierEditor
{
public:
...
#endif // __OVITO_LOAD_TRAJECTORY_MODIFIER_EDITOR_H
