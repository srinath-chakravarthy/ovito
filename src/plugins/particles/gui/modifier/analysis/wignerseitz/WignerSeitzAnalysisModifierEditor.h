...
#ifndef __OVITO_WIGNER_SEITZ_ANALYSIS_MODIFIER_EDITOR_H
#define __OVITO_WIGNER_SEITZ_ANALYSIS_MODIFIER_EDITOR_H
...
#endif // __OVITO_WIGNER_SEITZ_ANALYSIS_MODIFIER_EDITOR_H
