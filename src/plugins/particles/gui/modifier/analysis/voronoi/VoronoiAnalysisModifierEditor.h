...
public:
	...
	/// Returns whether the modifier generates nearest neighbor bonds.
	bool computeBonds() const { return _computeBonds; }

	/// Sets whether the modifier generates nearest neighbor bonds.
	void setComputeBonds(bool computeBonds) { _computeBonds = computeBonds; }
...
private:
	...
	PropertyField<bool> _computeBonds;
...
private:
	...
	DECLARE_PROPERTY_FIELD(_computeBonds);
