...
#ifndef __OVITO_COMMON_NEIGHBOR_ANALYSIS_MODIFIER_EDITOR_H
#define __OVITO_COMMON_NEIGHBOR_ANALYSIS_MODIFIER_EDITOR_H
...
#endif // __OVITO_COMMON_NEIGHBOR_ANALYSIS_MODIFIER_EDITOR_H
