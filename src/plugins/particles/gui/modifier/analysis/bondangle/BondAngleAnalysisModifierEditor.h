...
#ifndef __OVITO_BOND_ANGLE_ANALYSIS_MODIFIER_EDITOR_H
#define __OVITO_BOND_ANGLE_ANALYSIS_MODIFIER_EDITOR_H
...
#endif // __OVITO_BOND_ANGLE_ANALYSIS_MODIFIER_EDITOR_H
