...
#ifndef __OVITO_TRAJECTORY_GENERATOR_OBJECT_EDITOR_H
#define __OVITO_TRAJECTORY_GENERATOR_OBJECT_EDITOR_H
...
#endif // __OVITO_TRAJECTORY_GENERATOR_OBJECT_EDITOR_H
